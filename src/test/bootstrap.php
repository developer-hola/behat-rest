...
$configuration->pushConfigurationFromFiles(
    array(__DIR__ . "/../main/resources/config/config.yml"),
    array("common")
);
...
set_include_path(
    ...
    PATH_SEPARATOR . $configuration->getProperty("TEST_PATH") .
    PATH_SEPARATOR . $configuration->getProperty("MOCKS_PATH") .
    PATH_SEPARATOR . get_include_path()
);

// Cleaning up ConfigMediator.
$configuration->popConfigurationsFromQueue(
    array_reverse($configuration->getFilesRead())
);
